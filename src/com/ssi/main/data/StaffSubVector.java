...
public class StaffSubVector extends Vector<Object> implements Serializable, ISubDataVector{
    ...
    public StaffSubVector(String qrCode, String name, String title, Boolean flag) {
        super(Arrays.asList(new Object[]{null, qrCode, name, title, flag}));
    }
    
    public StaffSubVector(String qrCode, String name, String title) {
        super(Arrays.asList(new Object[]{null, qrCode, name, title, Boolean.FALSE}));
    }
    ...
    public synchronized String toString() {
        return "{"+Messages.getString("StaffView.table.column_title_qrcode")+":\""+this.get(1)
                ...
                +"\", "+Messages.getString("StaffView.table.column_title_choose")+":\""+this.get(4)
                +"\"}";
    }

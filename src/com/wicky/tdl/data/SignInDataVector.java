...
public class SignInDataVector extends Vector<ISubDataVector> implements Serializable, IDataVector<ISubDataVector>{
    ...
    public synchronized boolean add(String qrCode, String name, String salutaion, Boolean flag) {
        return this.add(new SignInSubVector(qrCode, name, salutaion, flag));
    }
    
    public synchronized boolean add(String qrCode, String name, String salutaion) {
        return this.add(new SignInSubVector(qrCode, name, salutaion));
    }

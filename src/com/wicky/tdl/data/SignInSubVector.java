...
public class SignInSubVector extends Vector<Object> implements Serializable, ISubDataVector{
    private static final long serialVersionUID = -8903166408920564591L;
    
    public SignInSubVector(String qrCode, String name, String salutaion, Boolean flag) {
        super(Arrays.asList(new Object[]{null, qrCode, name, salutaion, flag}));
    }
    
    public SignInSubVector(String qrCode, String name, String salutaion) {
